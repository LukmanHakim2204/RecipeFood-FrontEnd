...
import CategoryLatesDetailRecipeWrapper from "../wrappers/CategoryLatestRecipeWrapper";
...
export default function CategoryDetails() {
    ...
    return (
        <>
            ...
            <CategoryDetailsDetailRecipesWrapper></CategoryDetailsDetailRecipesWrapper>
            <CategoryLatesDetailRecipeWrapper></CategoryLatesDetailRecipeWrapper>
        </>
